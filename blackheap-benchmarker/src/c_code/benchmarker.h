...
enum error_codes {
  ...
  ERROR_CODES_DROP_PAGE_CACHE_FAILED_NO_PERMISSIONS = 8,
  ERROR_CODES_DROP_PAGE_CACHE_FAILED_OTHER = 9,

  ERROR_CODES_INCORRECT_FILE_BUFFER_SIZE = 10,

  ERROR_CODES_TOO_SMALL_FILE_BUFFER = 11,
};
